...
/**
 * Ringer manager from the Phone app's Ringer ,modify some .
 */
public class Ringer {
    private static final String LOG_TAG = "SyncPhone";
...
//    }
    ...
    void ring() {
        ...
        synchronized (this) {
            // need permisson.DEVICE_POWER .BUT that is only for system app
//            try {
//                if (true/*PhoneApp.getInstance().showBluetoothIndication()*/) {
...
//            }
    ...
    boolean shouldVibrate() {
        ...
        if (mEnableVibrate/*CallFeaturesSetting.getVibrateWhenRinging(mContext)*/) {
